...
export class WallPhysicsController extends PhysicsBodyController {
    ...
    private static hitboxDef: b2FixtureDef = {
        shape: WallPhysicsController.bodyShape,
        density: 1.0,
        friction: 0.0,
        filter: {
    ...
    onAdded(world: World): void {
        ...
        */
        ...
        const body: b2Body = world.b2world.CreateBody(WallPhysicsController.bodyDef);
        ...
        */
        ...
        const hitbox = body.CreateFixture(WallPhysicsController.hitboxDef);
